...
def removeNthFromEnd(head, n):
    ...
    # init stopper node by traversing n nodes ahead of head node
    # Traverse LL on condition of stopper node not being None
    ...
    for _ in range(0, n):
        stopper_node = stopper_node.next

    while stopper_node is not None:
        prev_node = curr_node
        curr_node = curr_node.next
        stopper_node = stopper_node.next
